...
import mobilePeople from '~/public/images/mobile.png'
...
const People = () => {
    ...
    return ( <section className="flex flex-col gap-20 w-full bg-darkBlue  px-20 py-20 lg:py-10 lg:gap-10  md:px-5 sm:gap-5 overflow-hidden">
<Image src={people} alt="" style={float}   className="sm:hidden "/>
<Image src={mobilePeople} alt="" style={float}   className="hidden  sm:flex w-[80%] mx-auto "/>
...
<Image src={bonjour} alt=""  style={float} className="sm:hidden "  />
<Image src={mobileSec} alt="" style={float}   className="hidden  sm:flex w-[80%] mx-auto "/>
    </section> );
}
