...
const Hero = () => {
    return ( <section  className="w-full h-screen relative  p-8 bg-darkBlue  flex  items-center justify-center min-h-[650px] md:p-2 sm:h-">
        
        <div className="w-full h-full relative flex  items-center justify-center"><Image src={family} alt="family" priority fill className="object-cover rounded-2xl z-10 object-top" />
...
<div className="flex flex-col gap-20  items-start   w-1/2  lg:gap-10 sm:order-2 ">
...
<div className="flex flex-col gap-4  items-start   w-1/2    w-[440px] lg:w-[300px] md:w-[250px] md:gap-2 sm:order-1 sm:w-[60%] sm:self-end">
