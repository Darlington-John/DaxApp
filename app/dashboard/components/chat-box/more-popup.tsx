...
const More = (item: any) => {
    ...
    return (  
        more && (<div className={`flex flex-col bg-deepBlue   absolute ${positionClass} w-[200px] rounded-md overflow-hidden z-[200] duration-300 ease  sm:top-0   ${isMore ? 'opacity-100' :  ' opacity-0'}   ${props.sender.phone !== user.phone ?'left-[102%]  sm:left-[0%]': 'right-[102%] sm:right-[0%] '}`} ref={moreRef}>
